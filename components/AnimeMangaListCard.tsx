    ...
    return (
        ...
        >
            <div 
                ...
                className="group anime-list-card flex items-center gap-3 p-2 border-2 rounded-2xl mb-2 cursor-pointer relative overflow-visible transition-all ease-in-out "
                onClick={() => {
